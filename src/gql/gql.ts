 ...
 */
export function graphql(source: "mutation CartCreate($items: [OrderProductInput!]!) {\n  orderCreate(items: $items) {\n    ...Cart\n  }\n}"): typeof import('./graphql').CartCreateDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CartIncrementItems($id: ID!, $items: [OrderProductInput!]!) {\n  orderItemsUpdate(id: $id, items: $items, updateMethod: INCREMENT) {\n    ...Cart\n  }\n}"): typeof import('./graphql').CartIncrementItemsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CartUpdate($id: ID!, $items: [OrderProductInput!]!) {\n  orderItemsUpdate(id: $id, items: $items, updateMethod: SET) {\n    ...CartDetails\n  }\n}"): typeof import('./graphql').CartUpdateDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
